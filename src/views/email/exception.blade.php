...
<head>
    <meta charset="utf-8">
    <title>Laravel Exception Mailer</title>
</head>
<body style="color: #2B2B2B;font: 14px 'Lucida Grande','Lucida Sans Unicode','Lucida Sans',Geneva,Verdana,sans-serif;min-height:500px;height:100%">
